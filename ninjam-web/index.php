...
<div class="container">
    <div class="py-5">
        <div id="jp_container_N" style="width: 300px; display: table; margin: 0 auto;" class="jp-audio"
            ...
            <div class="jp-type-playlist">
                ...
                <div class="jp-gui">
                    ...
                    <div class="jp-interface" style="width: 300px;">
                        <div class="jp-progress" style="left: 120px; top: 20px; width: 150px;">
                            <div class="jp-seek-bar">
                                <div class="jp-play-bar"></div>
                            </div>
                        </div>
                        <div class="jp-current-time" style="font-size: 1em; width: 60px" role="timer" aria-label="time">&nbsp;</div>
                        <div class="jp-controls-holder" style="width: 300px;">
                            <div class="jp-controls" style="padding-top: 10px; width: 150px;">
                                <!--button class="jp-previous" role="button" tabindex="0">previous</button-->
                                <button class="jp-play" role="button" tabindex="0">play</button>
                                <!--button class="jp-next" role="button" tabindex="0">next</button-->
                                <button class="jp-stop" role="button" tabindex="0">stop</button>
                            </div>
                            <div class="jp-volume-controls" style="left: 123px; width: 200px;">
                                <button class="jp-mute" role="button" tabindex="0">mute</button>
                                <button class="jp-volume-max" style="left: 128px;" role="button" tabindex="0">max volume</button>
                                <div class="jp-volume-bar"  style="width: 100px;">
